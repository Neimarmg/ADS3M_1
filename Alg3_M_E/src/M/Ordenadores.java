...
/**
 * Classe responsável pela ordenação de dados carregados de um arquivo 
...
//========================= << Ordenação BubleSort >> ==============================
	...
	/**
	 * Método responsável pelo carregamento do ordenador bubleSort
	 * @throws Exception
	 */
...
//=============== << Menu de acesso aos ordenadores >> ===============================
	...
	/**
	 * Método que exibe o cabeçalho com ordem de execução, crescente ou decrescente
	 * @param ordem
	...
	private static void informaStatistica(boolean mostraEstatisca) {
		if (mostraEstatisca == true) {
			View.msg(
				...
				+ "\nTotal de comparacôes: " + Auxiliar.getContador()
	...
	/**
	 * Método geral de impressão da lista de dados dos ordenadores
	 * @param ordem
	 * @param mostraEstatisca
	 * @param limpaVetor
